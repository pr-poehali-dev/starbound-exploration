...
export const IntegrationCarousel = ({
  ...
  buttonHref = "#",
  title = "Работает с системами вашего вуза.",
  subtitle = "Дневник интегрируется с LMS-платформами, Google Classroom, Moodle и другими учебными системами — данные синхронизируются автоматически.",
